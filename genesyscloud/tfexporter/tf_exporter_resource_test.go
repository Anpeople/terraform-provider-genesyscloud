...
func (r *registerTestInstance) registerTestResources() {
	...
	providerResources["genesyscloud_routing_queue_conditional_group_routing"] = routingQueueCondtionalGroupRouting.ResourceRoutingQueueConditionalGroupRouting()
...
func (r *registerTestInstance) registerTestExporters() {
	...
	RegisterExporter("genesyscloud_routing_queue_conditional_group_routing", routingQueueCondtionalGroupRouting.RoutingQueueConditionalGroupRoutingExporter())
